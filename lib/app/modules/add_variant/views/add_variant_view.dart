...
class AddVariantView extends GetView<AddVariantController> {
  AddVariantView({Key? key}) : super(key: key);
                    ...
                    child: Obx(
                      () => Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            controller: controller.engineOilController,
                            textAlignVertical: TextAlignVertical.center,
                            keyboardType: TextInputType.number,
                            inputFormatters: [
                              FilteringTextInputFormatter.allow(
                          ...
                          TextFormField(
                            controller: controller.gearOilController,
                            textAlignVertical: TextAlignVertical.center,
                            keyboardType: TextInputType.number,
                            inputFormatters: [
                              FilteringTextInputFormatter.allow(
                          ...
                          TextFormField(
                            controller: controller.tyreController,
                            textAlignVertical: TextAlignVertical.center,
                            keyboardType: TextInputType.number,
                            inputFormatters: [
                              FilteringTextInputFormatter.allow(
